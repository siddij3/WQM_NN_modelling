...
if __name__ == '__main__':
    ...
    R_meas_cont , mae_averages_meas_cont  = isolateParam(optimal_NNs , all_features, str_meas_cont, param_batches, vbs, str_reg )
    ...
    R_sens_num, mae_averages_sens_num  = isolateParam(optimal_NNs , all_features, str_sens_num, param_batches, vbs, str_reg )
